...
atStart = MSE(W, 0, trainData, trainTarget, reg=0.5)

grad_descent(W, 0 ,trainData,trainTarget,alpha=0.005,iterations=0.0,reg=0.5,EPS=1e-7)

atEnd = MSE(W, 0, trainData, trainTarget, reg=0.5)
print(atStart,atEnd)
